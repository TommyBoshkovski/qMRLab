...
.. raw:: html
   ...
   <span class="comment">% =========================================================================</span>
   </pre><h2 >I- DESCRIPTION<a name="2"></a></h2><pre class="codeinput">qMRinfo(<span class="string">'mt_sat'</span>); <span class="comment">% Display help</span>
   ...
   </pre><h2 >II- INITIALIZE MODEL OBJECT<a name="3"></a></h2><p >-------------------------------------------------------------------------</p><h2 >A- CREATE MODEL OBJECT<a name="4"></a></h2><p >-------------------------------------------------------------------------</p><pre class="codeinput">Model = mt_sat;
   ...
   <span class="comment">% -------------------------------------------------------------------------</span>
   </pre><img src="_static/mt_sat_batch_01.png" vspace="5" hspace="5" style="width:569px;height:802px;" alt=""> <h2 >C- LOAD PROTOCOL<a name="6"></a></h2><pre class="language-matlab">	   |- Respective command <span class="string">lines</span> <span class="string">appear</span> <span class="string">if</span> <span class="string">required</span> <span class="string">by</span> <span class="string">mt_sat.</span>
   -------------------------------------------------------------------------
   </pre><pre class="codeinput"><span class="comment">% mt_sat object needs 3 protocol field(s) to be assigned:</span>
   
   
   <span class="comment">% MT</span>
   <span class="comment">% T1</span>
   <span class="comment">% PD</span>
   <span class="comment">% --------------</span>
   FlipAngle = 6;
   TR  = 0.028;
   Model.Prot.MT.Mat = [ FlipAngle TR ];
   <span class="comment">% -----------------------------------------</span>
   FlipAngle = 20;
   TR = 0.018;
   ...
   <span class="comment">% -----------------------------------------</span>
   </pre><h2 >III- FIT EXPERIMENTAL DATASET<a name="7"></a></h2><p >-------------------------------------------------------------------------</p><h2 >A- LOAD EXPERIMENTAL DATA<a name="8"></a></h2><pre >         |- Respective command lines appear if required by mt_sat.
   -------------------------------------------------------------------------
   ...
   data.MTw=double(load_nii_data(<span class="string">'/Users/tommyboshkovski/Documents/GitHub/qMRLab/Data/mt_sat_demo/mt_sat_data/MTw.nii.gz'</span>));
   <span class="comment">% T1w.nii.gz contains [128  128   96] data.</span>
   data.T1w=double(load_nii_data(<span class="string">'/Users/tommyboshkovski/Documents/GitHub/qMRLab/Data/mt_sat_demo/mt_sat_data/T1w.nii.gz'</span>));
   <span class="comment">% PDw.nii.gz contains [128  128   96] data.</span>
   data.PDw=double(load_nii_data(<span class="string">'/Users/tommyboshkovski/Documents/GitHub/qMRLab/Data/mt_sat_demo/mt_sat_data/PDw.nii.gz'</span>));
   ...
   </pre><img src="_static/mt_sat_batch_02.png" vspace="5" hspace="5" style="width:560px;height:420px;" alt=""> <h2 >IV- SAVE MAPS AND OBJECT<a name="11"></a></h2><pre class="codeinput">Model.saveObj(<span class="string">'mt_sat_Demo.qmrlab.mat'</span>);
   ...
   </pre><h2 >V- SIMULATIONS<a name="12"></a></h2><pre >   |- This section can be executed to run simulations for 'mt_sat.
