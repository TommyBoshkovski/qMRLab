...
.. raw:: html
   ...
   <span class="comment">% =========================================================================</span>
   </pre><h2 >I- DESCRIPTION<a name="2"></a></h2><pre class="codeinput">qMRinfo(<span class="string">'qmt_sirfse'</span>); <span class="comment">% Display help</span>
   ...
   </pre><h2 >II- INITIALIZE MODEL OBJECT<a name="3"></a></h2><p >-------------------------------------------------------------------------</p><h2 >A- CREATE MODEL OBJECT<a name="4"></a></h2><p >-------------------------------------------------------------------------</p><pre class="codeinput">Model = qmt_sirfse;
   ...
   <span class="comment">% -------------------------------------------------------------------------</span>
   </pre><img src="_static/qmt_sirfse_batch_01.png" vspace="5" hspace="5" style="width:569px;height:802px;" alt=""> <h2 >C- LOAD PROTOCOL<a name="6"></a></h2><pre class="language-matlab">	   |- Respective command <span class="string">lines</span> <span class="string">appear</span> <span class="string">if</span> <span class="string">required</span> <span class="string">by</span> <span class="string">qmt_sirfse.</span>
   -------------------------------------------------------------------------
   ...
   <span class="comment">% -----------------------------------------</span>
   </pre><h2 >III- FIT EXPERIMENTAL DATASET<a name="7"></a></h2><p >-------------------------------------------------------------------------</p><h2 >A- LOAD EXPERIMENTAL DATA<a name="8"></a></h2><pre >         |- Respective command lines appear if required by qmt_sirfse.
   -------------------------------------------------------------------------
   ...
   data.MTdata=double(load_nii_data(<span class="string">'/Users/tommyboshkovski/Documents/GitHub/qMRLab/Data/qmt_sirfse_demo/qmt_sirfse_data/MTdata.nii.gz'</span>));
   <span class="comment">% Mask.nii.gz contains [128  128] data.</span>
   data.Mask=double(load_nii_data(<span class="string">'/Users/tommyboshkovski/Documents/GitHub/qMRLab/Data/qmt_sirfse_demo/qmt_sirfse_data/Mask.nii.gz'</span>));
   ...
   </pre><img src="_static/qmt_sirfse_batch_02.png" vspace="5" hspace="5" style="width:560px;height:420px;" alt=""> <img src="_static/qmt_sirfse_batch_03.png" vspace="5" hspace="5" style="width:560px;height:420px;" alt=""> <h2 >IV- SAVE MAPS AND OBJECT<a name="11"></a></h2><pre class="codeinput">Model.saveObj(<span class="string">'qmt_sirfse_Demo.qmrlab.mat'</span>);
   ...
   </pre><h2 >V- SIMULATIONS<a name="12"></a></h2><pre >   |- This section can be executed to run simulations for 'qmt_sirfse.
   ...
   <span class="comment">% -------------------------------------------------------------------------</span>
   </pre><img src="_static/qmt_sirfse_batch_04.png" vspace="5" hspace="5" style="width:560px;height:420px;" alt=""> <h2 >B- Sensitivity Analysis<a name="14"></a></h2><pre >         |-    Simulates sensitivity to fitted parameters:
   ...
   </pre><img src="_static/qmt_sirfse_batch_05.png" vspace="5" hspace="5" style="width:560px;height:420px;" alt=""> <p class="footer"><br ><a href="http://www.mathworks.com/products/matlab/">Published with MATLAB R2016a</a><br ></p></div>
